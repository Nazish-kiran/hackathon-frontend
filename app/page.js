        ...
        <nav className="shadow-lg">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
              ...
              <Link href={"/UserLogin"}>
                <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg transition duration-200 mr-12">
                  Login
                </button>
              </Link>
            </div>
        ...
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              A platform to showcase innovative projects, collaborate with
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {[1, 2, 3].map((item) => (
                <div
                  key={item}
                  className="p-6 bg-zinc-200 rounded-lg shadow-lg hover:shadow-xl transition duration-300"
                >
        ...
        <footer className="bg-gray-800 text-white py-8">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <p className="text-gray-400">
              &copy; 2023 ProjectHub. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
